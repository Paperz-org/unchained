...
class Unchained:
    ...
    @cached_property
    def app(self):
        get_asgi_application = self._import_module('django.core.asgi', 'get_asgi_application')
    ...
    def _create_app_files(self, app_dir, migrations_dir):
        ...
        files_to_create = [
            ...
            (os.path.join(migrations_dir, '__init__.py'), '# Django migrations package\n'),
            (os.path.join(app_dir, 'models.py'), '# Models will be added dynamically\n'),
            (os.path.join(app_dir, 'apps.py'), f'''from django.apps import AppConfig
...
'''),
    ...
    def register_model(self, model_class):
        ...
        if not hasattr(model_class._meta, 'app_label') or model_class._meta.app_label != self.APP_NAME:
    ...
    def _detect_and_register_models(self):
        ...
        try:
            ...
            from models_base import MainAppModelMeta, MODEL_REGISTRY
            ...
            if models:
                ...
                for model in models:
                    ...
                    if hasattr(model._meta, 'app_label') and model._meta.app_label != self.APP_NAME:
